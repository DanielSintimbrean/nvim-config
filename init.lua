...
vim.keymap.set('v', 'J', ":m '>+1<CR>gv=gv", { desc = 'Move selected lines one line UP [j]' })
vim.keymap.set('v', 'K', ":m '<-2<CR>gv=gv", { desc = 'Move selected lines one line DOWN [k]' })

--- Preserve the 0 register when pasting
vim.keymap.set('x', '<leader>p', '"_dP', { desc = 'Move selected lines one line DOWN [k]' })
